...
{
    uint mm_master_status = ServerInfo::MASTER | ServerInfo::RUNNING;
    uint mm_slave_status = ServerInfo::RELAY | ServerInfo::SLAVE | ServerInfo::RUNNING;
    uint slave_status = ServerInfo::SLAVE | ServerInfo::RUNNING;
    uint running_status = ServerInfo::RUNNING;
